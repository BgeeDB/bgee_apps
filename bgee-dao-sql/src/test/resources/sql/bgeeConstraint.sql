...
add unique(geneId, anatEntityId, stageId);
...
modify noExpressionId int unsigned not null auto_increment primary key,
add unique(geneId, anatEntityId, stageId);
...
modify globalNoExpressionId int unsigned not null auto_increment primary key,
add unique(geneId, anatEntityId, stageId);
...
add primary key (globalNoExpressionId, noExpressionId);
...
add unique(geneId, anatEntityId, stageId, comparisonFactor);
