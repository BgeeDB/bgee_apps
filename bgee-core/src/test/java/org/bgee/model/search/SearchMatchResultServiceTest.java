...
public class SearchMatchResultServiceTest extends TestAncestor {
    ...
    public void shouldAutocomplete() throws SphinxException {
        ...
        String term = "ENSG";
        when(sphinxClient.Query(SearchMatchResultService.getFormattedQueryTerm(term), "autocomplete_index")).thenReturn(sphinxResult);
    ...
    public void shouldFindGeneByTerm() throws SphinxException {
        ...
        String term = "Syn2";
        when(sphinxClient.Query(SearchMatchResultService.getFormattedQueryTerm(term), "genes_index")).thenReturn(sphinxResult);
        ...
        Gene expGene = new Gene("ENSG0086", "Name1", "Desc1", 
                new HashSet<>(Arrays.asList("Syn1", "Syn2", "Syn3")), null, expSpecies, new GeneBioType("geneBioType1"), null, 1, null);
    ...
    public void shouldFindAnatEntityByTerm() throws SphinxException {
        ...
        sphinxMatch2.attrValues.add("ID:0002");  //anatEntityId
        sphinxMatch2.attrValues.add("anat2");    //anatEntityName
        sphinxMatch2.attrValues.add("9606");     //speciesId
        sphinxMatch2.attrValues.add(2);          //type
        SphinxMatch sphinxMatch3 = new SphinxMatch(1, 1);
        sphinxMatch3.attrValues.add("ID:0003");  //anatEntityId
        sphinxMatch3.attrValues.add("anat2");    //anatEntityName
        ...
        sphinxMatch4.attrValues.add("ID:0004");  //anatEntityId
        sphinxMatch4.attrValues.add("an4");    //anatEntityName
        ...
        String term = "anat";
        when(sphinxClient.Query(SearchMatchResultService.getFormattedQueryTerm(term), "anat_entities_index")).thenReturn(sphinxResult);
        ...
        assertFalse(anatMatchResult.getSearchMatches().isEmpty());
        assertEquals(3, anatMatchResult.getSearchMatches().size());
        getLogger().info("Results: {}", anatMatchResult.getSearchMatches());

        AnatEntity expAE = new AnatEntity("ID:0001", "anat1", null);

        assertEquals(new SearchMatch<AnatEntity>(expAE, null, SearchMatch.MatchSource.NAME, AnatEntity.class),
    ...
    public void shouldFindByTerm_noResult() throws SphinxException {
        ...
        assertTrue(geneMatchResult.getSearchMatches().isEmpty());
    }
}
