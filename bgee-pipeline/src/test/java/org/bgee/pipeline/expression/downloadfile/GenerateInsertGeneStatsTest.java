...
public class GenerateInsertGeneStatsTest extends TestAncestor {
    ...
    public void shouldGenerateStatFiles() throws IOException {
        ...
        Species sp1 = new Species(9606, null, null, "Genus11", "spName1", null, null);
        Species sp2 = new Species(10090, null, null, "Genus22", "spName2", null, null);
        ...
        Gene gene1sp1 = new Gene("geneId1", "gene name 1 sp 1", "gene desc 1 sp1", sp1, geneBioType1, 1);
        Gene gene1sp2 = new Gene("geneId1", "gene name 1 sp 2", "gene desc 1 sp2", sp2, geneBioType1, 1);
        Gene gene2sp2 = new Gene("geneId2", "gene name 2", "gene desc 2", sp2, geneBioType2, 1);
        ...
        condAttrs.add(CallService.Attribute.GLOBAL_MEAN_RANK);
