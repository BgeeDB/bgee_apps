...
public class CommandDownloadTest extends TestAncestor {
    ...
    public static List<SpeciesDataGroup> getTestGroups() {
        log.entry();
        //Species:
        Species spe1 = new Species(9606, "human", null, "Homo", "sapiens", "hsap1", new Source(1), 1234);
        Species spe2 = new Species(10090, "mouse", null, "Mus", "musculus", "mmus1", new Source(1), 2322);
        Species spe3 = new Species(7955, "zebrafish", null, "Danio", "rerio", "dre1", new Source(1), 2311);
        Species spe4 = new Species(7227, "fly", null, "Drosophila", "melanogaster", "dmel1", new Source(1), 211);
