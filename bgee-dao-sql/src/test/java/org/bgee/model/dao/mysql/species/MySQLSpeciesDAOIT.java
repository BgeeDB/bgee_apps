...
public class MySQLSpeciesDAOIT extends MySQLITAncestor {
    ...
    public void shouldInsertSpecies() throws SQLException {
        ...
        speciesTOs.add(new SpeciesTO(10, "commonName1", "genus1", "speciesName1", 2,
                100, "path/1", "1", "assemblyXRef", 1, null, false, "xref1"));
        speciesTOs.add(new SpeciesTO(20, "commonName2", "genus2", "speciesName2", 1,
                120, "path/2", "2", "assemblyXRef", 1, 200, false, "xref1"));
        speciesTOs.add(new SpeciesTO(30, "commonName3", "genus3", "speciesName3", 3,
                500, "path/3", "3", "assemblyXRef", 1, 200, false, "xref1"));
        try {
    ...
    public void shouldGetAllSpecies() throws SQLException {
        ...
        expectedSpecies = Arrays.asList(
                new SpeciesTO(null, "spCName11", null, null, null, null, null, null, null, null, null, null, null),
                new SpeciesTO(null, "spCName21",null, null,  null, null, null, null, null, null, null, null, null),
                new SpeciesTO(null, "spCName31", null, null, null, null, null, null, null, null, null, null, null),
                new SpeciesTO(null, "spCName41", null, null, null, null, null, null, null, null, null, null, null),
                new SpeciesTO(null, "spCName42", null, null, null, null, null, null, null, null, null, null, null),
                new SpeciesTO(null, "spCName51", null, null, null, null, null, null, null, null, null, null, null));
        // Compare
        assertTrue("SpeciesTOs incorrectly retrieved",
                TOComparator.areTOCollectionsEqual(methSpecies, expectedSpecies));
    }
    ...
    public void shouldGetSpeciesByIds() throws SQLException {
        ...
        List<SpeciesTO> expectedSpeciesTOs = Arrays.asList(
                new SpeciesTO(11, "spCName11", "gen11", "sp11", 4, 111,
                        "gen11_sp11/gen11_sp11.genome11", "genome11", "assemblyXRef11", 1, 0, false, null),
                new SpeciesTO(31, "spCName31", "gen31", "sp31", 1, 311,
                        "gen31_sp31/gen31_sp31.genome31", "genome31", "assemblyXRef31", 1, 0, false, null));
        // Compare
        ...
        expectedSpeciesTOs = Arrays.asList(
                new SpeciesTO(11, null, "gen11", "sp11", null, null, null, null, null, null, null, null, null),
                new SpeciesTO(31, null, "gen31", "sp31", null, null, null, null, null, null, null, null, null));
        // Compare
        assertTrue("SpeciesTOs incorrectly retrieved, expected: " + expectedSpeciesTOs + 
                ", but was: " + speciesTOs, 
                TOComparator.areTOCollectionsEqual(speciesTOs, expectedSpeciesTOs));
        ...
        // Generate manually expected result
        expectedSpeciesTOs = Arrays.asList(
                new SpeciesTO(11, null, "gen11", "sp11", 4, null, null, null, null, null, null, null, null),
                new SpeciesTO(31, null, "gen31", "sp31", 1, null, null, null, null, null, null, null, null));
        // Compare
        assertTrue("SpeciesTOs incorrectly retrieved, expected: " + expectedSpeciesTOs + 
                ", but was: " + speciesTOs, 
                TOComparator.areTOCollectionsEqual(speciesTOs, expectedSpeciesTOs));
    ...
    public void testGetSpeciesInDataGroup() throws SQLException {
        ...
        List<SpeciesTO> expectedSpecies = Arrays.asList(
                new SpeciesTO(41, "spCName41", "gen41", "sp41", 2, 411, 
                        "gen41_sp41/gen41_sp41.genome41", "genome41", "assemblyXRef41", 1, 0, false, null),
                new SpeciesTO(21, "spCName21", "gen21", "sp21", 3, 211, 
                        "gen51_sp51/gen51_sp51.genome51", "genome51", "assemblyXRef51", 1, 51, false, null),
                new SpeciesTO(51, "spCName51", "gen51", "sp51", 6, 511, 
                        "gen51_sp51/gen51_sp51.genome51", "genome51", "assemblyXRef51", 1, 0, false, null));
        // Compare
        assertTrue("SpeciesTOs incorrectly retrieved",
                TOComparator.areTOCollectionsEqual(methSpecies, expectedSpecies));
