...
mvn install:install-file -Dfile=source_libraries/owltools-runner-all.jar -DgroupId=org.bbop -DartifactId=OWLTools-all -Dversion=0.3.0-SNAPSHOT-owlapi-5.1.17 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=repository/
