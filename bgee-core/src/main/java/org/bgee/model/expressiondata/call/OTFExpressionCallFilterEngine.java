...
//                Set<String> allowedAnatIds = anat.getIds();
//                p = p.and(call -> {
//                    String anatId = call.getCondition()
//                            .getConditionParameterValue(ConditionParameter.ANAT_ENTITY_CELL_TYPE)
//                            .getEntity(1).getId();
//    
//                    boolean accepted = allowedAnatIds.contains(anatId);
//    
//                    log.debug(
//                        "Gene={} Condition={} ANAT={} Allowed={} -> {}",
...
//                });
//            }
//            if (anat.getExcludeTermsAndChildrenIds() != null && !anat.getExcludeTermsAndChildrenIds().isEmpty()) {
//                Set<String> excludedAnatIds = anat.getExcludeTermsAndChildrenIds();
//                p = p.and(call -> {
//                    String anatId = call.getCondition()
//                            .getConditionParameterValue(ConditionParameter.ANAT_ENTITY_CELL_TYPE)
//                            .getEntity(1).getId();
//    
//                    boolean accepted = !excludedAnatIds.contains(anatId);
//    
//                    log.debug(
//                        "Gene={} Condition={} ANAT={} Excluded={} -> {}",
//                        call.getGene().getGeneId(),
//                        call.getCondition(),
//                        anatId,
//                        excludedAnatIds,
...
//        }
//
//        // CELL TYPE (same parameter but index 1)
...
//
//                Set<String> allowedCellTypeIds = cell.getIds();
//                p = p.and(call -> {
//                    String cellId = call.getCondition()
//                            .getConditionParameterValue(ConditionParameter.ANAT_ENTITY_CELL_TYPE)
//                            .getEntity(0).getId();
//    
//                    boolean accepted = allowedCellTypeIds.contains(cellId);
//    
//                    log.debug(
//                        "Gene={} CELL={} Allowed={} -> {}",
//                        call.getGene().getGeneId(),
...
//                });
//            }
//            if (cell.getExcludeTermsAndChildrenIds() != null && !cell.getExcludeTermsAndChildrenIds().isEmpty()) {
//                Set<String> excludeCellIds = cell.getExcludeTermsAndChildrenIds();
//                p = p.and(call -> {
//                    String cellId = call.getCondition()
//                            .getConditionParameterValue(ConditionParameter.ANAT_ENTITY_CELL_TYPE)
//                            .getEntity(0).getId();
//    
//                    boolean accepted = !excludeCellIds.contains(cellId);
//    
//                    log.debug(
//                        "Gene={} Condition={} CELL={} Rejected={} -> {}",
//                        call.getGene().getGeneId(),
//                        call.getCondition(),
//                        cellId,
//                        excludeCellIds,
...
//
//        // Dev. stage
//        FilterIds<String> stage = filter.getComposedFilterIds(ConditionParameter.DEV_STAGE).getFilterIds(0);
...
//                );
//            }
//            if (stage.getExcludeTermsAndChildrenIds() != null && !stage.getExcludeTermsAndChildrenIds().isEmpty()) {
