 ...
 * @param <V>   The type of the elements returned by this {@code Stream}, which is always
 *              {@code List<T>}. The elements in the returned lists are sorted as returned by
 *              the source {@code Stream}.
 */
public class ElementGroupFromListSpliterator<T, U, V extends List<T>>
