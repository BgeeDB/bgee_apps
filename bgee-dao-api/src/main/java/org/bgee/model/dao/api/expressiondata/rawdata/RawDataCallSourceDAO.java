...
public class RawDataCallSourceDAO {
     ...
     * <li>{@code PVALUE}: corresponds to {@link CallSourceRawDataTO#getpValue()}.
    ...
    public enum Attribute implements DAO.Attribute {
        ASSAY_ID, BGEE_GENE_ID, PVALUE, EXPRESSION_CONFIDENCE, EXCLUSION_REASON, EXPRESSION_ID, RANK;
    }
    ...
    public static interface CallSourceTO<T extends Comparable<T>> extends Serializable {
        ...
        /**
         * Helper method to access to the pValue carried by the {@code CallSourceDataTO}
         * returned by {@link #getCallSourceDataTO()}.
         *
         * @return  the {@code BigDecimal} representing the pValue of the call source raw data.
         */
        public default BigDecimal getPValue() {
            return this.getCallSourceDataTO().getPValue();
        }
        /**
    ...
    public static class CallSourceDataTO extends TransferObject {
        ...
        public enum ExclusionReason implements EnumDAOField {
            ...
            BIOTYPE_NOT_TARGETED("biotype not targeted");
        ...
        /**
         * A {@code BigDecimal} representing the pvalue of the test to determine active signal 
         * of expression
         */
         ...
         * @param pValue                A {@code BigDecimal} representing the pValue of the test to 
         *                              determine active signal of expression
         ...
         */
        public CallSourceDataTO(Integer bgeeGeneId, BigDecimal pValue,
        ...
        /**
         * 
         * @return  A {@code BigDecimal} representing the pValue of the test to determine 
         *          active signal of expression
         */
