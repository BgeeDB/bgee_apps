...
public class BgeeDBUtilsTest extends TestAncestor {
    ...
    private SpeciesTOResultSet mockGetAllSpecies(MockDAOManager mockManager) {
        ...
        SpeciesTOResultSet mockSpeciesTORs = this.createMockDAOResultSet(
                Arrays.asList(
                        new SpeciesTO(21, null, null, null, null, null, null, null, null, null, null, null),
                        new SpeciesTO(11, null, null, null, null, null, null, null, null, null, null, null),
                        new SpeciesTO(30, null, null, null, null, null, null, null, null, null, null, null)),
    ...
    public void shouldGetGeneTOsByIds() {
        try (MockDAOManager mockManager = new MockDAOManager()) {
            ...
            GeneTO gene1 = new GeneTO(1, "1", "gene A", "desc A", 1, 1, true, "reg1", null, 1, null); 
            GeneTO gene2 = new GeneTO(2, "2", "gene B", "desc B", 2, 1, true, "reg1", null, 1, null); 
            GeneTO gene3 = new GeneTO(3, "3", "gene C", "desc C", 1, 2, true, "reg1", null, 1, null); 
        ...
        try (MockDAOManager mockManager = new MockDAOManager()) {
            List<GeneTO> returnedGeneTOs = Arrays.asList(
                    new GeneTO(1, "1", "gene A", "desc A", 1, 1, true, "reg1", null, 2, null), 
                    new GeneTO(1, "1", "gene B", "desc B", 1, 1, true, "reg1", null, 2, null));
