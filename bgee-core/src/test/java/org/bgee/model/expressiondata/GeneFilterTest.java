...
public class GeneFilterTest extends TestAncestor {
    ...
    public void shouldTest() {
        Gene gene = new Gene("gA", new Species(1), 1);
        ...
        assertFalse("Gene ID should not pass filter", filter.test(new Gene("gB", new Species(1), 1)));
        ...
        assertFalse("Species ID should not pass filter", filter.test(new Gene("gA", new Species(2), 1)));
        assertFalse("Gene ID should not pass filter", filter.test(new Gene("gB", new Species(1), 1)));
