...
public class MySQLGeneDAOIT extends MySQLITAncestor {
    ...
    public void shouldGetAllGenes() throws SQLException {
        ...
        List<GeneTO> expectedGenes = Arrays.asList(
                new GeneTO(1, "ID1", "genN1", "genDesc1", 11, 12, true, "reg1", null, 1, "expression summary"), 
                new GeneTO(2, "ID2", "genN2", "genDesc2", 21, 0, true, "reg1", null, 1, "expression summary"), 
                new GeneTO(3, "ID3", "genN3", "genDesc3", 31, 0, false, "reg1", null, 1, "expression summary"), 
                new GeneTO(4, "ID4", "genN4", "genDesc4", 21, 0, true, "reg1", null, 1, "expression summary")); 
        //Compare
        ...
        expectedGenes = Arrays.asList(
                new GeneTO(1, "ID1", null, null, null, null, null, null, null, null, "expression summary"), 
                new GeneTO(2, "ID2", null, null, null, null, null, null, null, null, "expression summary"), 
                new GeneTO(3, "ID3", null, null, null, null, null, null, null, null, "expression summary"),
                new GeneTO(4, "ID4", null, null, null, null, null, null, null, null, "expression summary"));
        //Compare
        assertTrue("GeneTOs incorrectly retrieved", 
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
    }
...
//    }
    ...
    public void shouldGetGenesByIds() throws SQLException {
        ...
        expectedGenes = Arrays.asList(
                new GeneTO(null, null, "genN1", null, null, null, null, null, null, null, "expression summary"), 
                new GeneTO(null, null, "genN2", null, null, null, null, null, null, null, "expression summary"), 
                new GeneTO(null, null, "genN4", null, null, null, null, null, null, null, "expression summary"));
        //Compare
        assertTrue("GeneTOs incorrectly retrieved", 
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
    }
    ...
    public void shouldGetGenesBySpeciesAndGeneIds() throws SQLException {
        ...
        List<GeneTO> expectedGenes = Arrays.asList(
                new GeneTO(1, "ID1", null, null, null, null, null, null, null, null, null), 
                new GeneTO(2, "ID2", null, null, null, null, null, null, null, null, null), 
                new GeneTO(3, "ID3", null, null, null, null, null, null, null, null, null),
                new GeneTO(4, "ID4", null, null, null, null, null, null, null, null, null));
        //Compare
        assertTrue("GeneTOs incorrectly retrieved", 
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
        ...
        expectedGenes = Arrays.asList(
                new GeneTO(1, "ID1", null, "genDesc1", null, null, null, null, null, null, "expression summary")); 
        //Compare
        assertTrue("GeneTOs incorrectly retrieved", 
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
    }
    ...
    public void shouldGetGenesByBgeeIds() throws SQLException {
        ...
        List<GeneTO> expectedGenes = Arrays.asList(
                new GeneTO(1, null, null, null, 11, null, null, null, null, null, "expression summary"),
                new GeneTO(2, null, null, null, 21, null, null, null, null, null, "expression summary"),
                new GeneTO(3, null, null, null, 31, null, null, null, null, null, "expression summary"),
                new GeneTO(4, null, null, null, 21, null, null, null, null, null, "expression summary"));
        //Compare
        assertTrue("GeneTOs incorrectly retrieved",
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
        ...
        expectedGenes = Arrays.asList(
                new GeneTO(null, null, null, "genDesc1", null, null, null, null, null, null, "expression summary"),
                new GeneTO(null, null, null, "genDesc2", null, null, null, null, null, null, "expression summary"),
                new GeneTO(null, null, null, "genDesc4", null, null, null, null, null, null, "expression summary"));
        //Compare
        assertTrue("GeneTOs incorrectly retrieved",
                TOComparator.areTOCollectionsEqual(methGenes, expectedGenes));
    }
    ...
    public void shouldUpdateGenes() throws SQLException {
        ...
        Collection<GeneTO> geneTOs = Arrays.asList(
                new GeneTO(1, "ID1", "GNMod1", "DescMod1", 31, 12, true, "reg1", null, 1, "expression summary"),
                new GeneTO(2, "ID2", "GNMod2", "DescMod2", 11, 12, false, "reg1", null, 1, "expression summary"));
