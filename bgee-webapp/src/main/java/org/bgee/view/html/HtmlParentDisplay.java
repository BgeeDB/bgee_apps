...
public class HtmlParentDisplay extends ConcreteDisplayParent {
    ...
    private void displayBgeeHeader() {
     ...
     // Resources menu
        ...
        navbar.append("<li><a href='https://bgeedb.wordpress.com' target='_blank' rel='noopener noreferrer'>Bgee blog</a></li>");
        ...
        // R package
        navbar.append("<li><a title='Download Bgee data with the BgeeDB R package' target='_blank' rel='noopener noreferrer' href='" + BGEEDB_R_PACKAGE_URL + "'>" +
                "<img class='social-img' alt='R logo' src='")
                .append(this.prop.getLogoImagesRootDirectory()).append("r_logo.png'></a></li>");

        // Twitter
        navbar.append("<li><a title='Follow @Bgeedb on Twitter' target='_blank' rel='noopener noreferrer' href='https://twitter.com/Bgeedb'>" +
...
//    }
    ...
    protected static String getImageSources() {
        ...
        sources.append("<p><i>Homo sapiens</i> picture by Leonardo da Vinci (Life time: 1519) [Public domain]. <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Da_Vinci%27s_Anatomical_Man.jpg#mediaviewer/File:Da_Vinci%27s_Anatomical_Man.jpg'>See <i>H. sapiens</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Mus musculus</i> picture by Rasbak [<a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0/'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AApodemus_sylvaticus_bosmuis.jpg'>See <i>M. musculus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Danio rerio</i> picture by Azul (Own work) [see page for license], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AZebrafisch.jpg'>See <i>D. rerio</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Drosophila melanogaster</i> picture by Andr&eacute; Karwath aka Aka (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/2.5'>CC-BY-SA-2.5</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ADrosophila_melanogaster_-_side_(aka).jpg'>See <i>D. melanogaster</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Caenorhabditis elegans</i> picture by Bob Goldstein, UNC Chapel Hill http://bio.unc.edu/people/faculty/goldstein/ (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ACelegansGoldsteinLabUNC.jpg'>See <i>C. elegans</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Pan troglodytes</i> picture by Thomas Lersch (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a>, <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0/'>CC-BY-SA-3.0</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by/2.5'>CC-BY-2.5</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ASchimpanse_Zoo_Leipzig.jpg'>See <i>P. troglodytes</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Pan paniscus</i> picture by Ltshears (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a> or <a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ABonobo1_CincinnatiZoo.jpg'>See <i>P. paniscus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Gorilla gorilla</i> picture by Brocken Inaglory (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a> or <a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AMale_gorilla_in_SF_zoo.jpg'>See <i>G. gorilla</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Macaca mulatta</i> picture by Aiwok (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0-2.5-2.0-1.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AMacaca_mulatta_3.JPG'>See <i>M. mulatta</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Rattus norvegicus</i> picture by Reg Mckenna (originally posted to Flickr as Wild Rat) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by/2.0'>CC-BY-2.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AWildRat.jpg'>See <i>R. norvegicus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Bos taurus</i> picture by User Robert Merkel on en.wikipedia (US Department of Agriculture) [Public domain], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AHereford_bull_large.jpg'>See <i>B. taurus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Sus scrofa</i> picture by Joshua Lutz (Own work) [Public domain], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ASus_scrofa_scrofa.jpg'>See <i>S. scrofa</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Equus caballus</i> picture by Doug Antczak Baker Institute for Animal Health College of Veterinary Medicine Cornell University [Public Domain], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Twilight20008-300.jpg#/media/File:Twilight20008-300.jpg'>See <i>E. caballus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Oryctolagus cuniculus</i> picture by JJ Harrison (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Oryctolagus_cuniculus_Tasmania_2.jpg#/media/File:Oryctolagus_cuniculus_Tasmania_2.jpg'>See <i>O. cuniculus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Canis lupus familiaris</i> picture by Mood210 (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Male_fawn_Boxer_undocked.jpg#/media/File:Male_fawn_Boxer_undocked.jpg'>See <i>C. lupus familiaris</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Felis catus</i> picture [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Valentino.jpg#/media/File:Valentino.jpg'>See <i>F. catus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Cavia porcellus</i> picture by Variraptor (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Yoyocochondinde.JPG#/media/File:Yoyocochondinde.JPG'>See <i>C. porcellus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Erinaceus europaeus</i> picture by Michael Gäbler (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File:Erinaceus_europaeus_(Linnaeus,_1758).jpg#/media/File:Erinaceus_europaeus_(Linnaeus,_1758).jpg'>See <i>E. europaeus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Monodelphis domestica</i> picture by <i>Marsupial Genome Sheds Light on the Evolution of Immunity.</i> Hill E, PLoS Biology Vol. 4/3/2006, e75 <a rel='nofollow' href='http://dx.doi.org/10.1371/journal.pbio.0040075'>http://dx.doi.org/10.1371/journal.pbio.0040075</a> [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by/2.5'>CC-BY-2.5</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AOpossum_with_young.png'>See <i>M. domestica</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Ornithorhynchus anatinus</i> picture by Dr. Philip Bethge (private) [<a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0-2.5-2.0-1.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AOrnithorhynchus.jpg'>See <i>O. anatinus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Gallus gallus</i> picture by Subramanya C K (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ARed_jungle_fowl.png'>See <i>G. gallus</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Anolis carolinensis</i> picture by PiccoloNamek (Moved from Image:P1010027.jpg) [<a target='_blank' rel='noopener noreferrer' href='" + gnuOrg + "'>GFDL</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0/'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AAnolis_carolinensis.jpg'>See <i>A. carolinensis</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Xenopus tropicalis</i> picture by V&aacute;clav Gvo&zcaron;d&iacute;k (http://calphotos.berkeley.edu) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/2.5'>CC-BY-SA-2.5</a>, <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/2.5'>CC-BY-SA-2.5</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3AXenopus_tropicalis01.jpeg'>See <i>X. tropicalis</i> picture via Wikimedia Commons</a></p>");
        sources.append("<p><i>Drosophila ananassae</i> picture by Nicolas Gompel [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-nc-sa/2.0/'>CC BY-NC-SA 2.0 FR</a>], <a target='_blank' rel='noopener noreferrer' href='http://gompel.org/drosophilidae'>See <i>D. ananassae</i> picture via Nicolas Gompel's lab website</a></p>");
        sources.append("<p><i>Drosophila mojavensis</i> picture by Nicolas Gompel [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-nc-sa/2.0/'>CC BY-NC-SA 2.0 FR</a>], <a target='_blank' rel='noopener noreferrer' href='http://gompel.org/drosophilidae'>See <i>D. mojavensis</i> picture via Nicolas Gompel's lab website</a></p>");
        sources.append("<p><i>Drosophila pseudoobscura</i> picture, <a target='_blank' rel='noopener noreferrer' href='http://metazoa.ensembl.org/i/species/large/Drosophila_pseudoobscura.png'>See <i>D. pseudoobscura </i> picture via Ensembl Metazoa</a></p>");
        sources.append("<p><i>Drosophila simulans</i> picture by Nicolas Gompel [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-nc-sa/2.0/'>CC BY-NC-SA 2.0 FR</a>], <a target='_blank' rel='noopener noreferrer' href='http://gompel.org/drosophilidae'>See <i>D. simulans</i> picture via Nicolas Gompel's lab website</a></p>");
        sources.append("<p><i>Drosophila virilis</i> picture by Nicolas Gompel [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-nc-sa/2.0/'>CC BY-NC-SA 2.0 FR</a>], <a target='_blank' rel='noopener noreferrer' href='http://gompel.org/drosophilidae'>See <i>D. virilis</i> picture via Nicolas Gompel's lab website</a></p>");
        sources.append("<p><i>Drosophila yakuba</i> picture by Nicolas Gompel [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-nc-sa/2.0/'>CC BY-NC-SA 2.0 FR</a>], <a target='_blank' rel='noopener noreferrer' href='http://gompel.org/drosophilidae'>See <i>D. yakuba</i> picture via Nicolas Gompel's lab website</a></p>");
        //        sources.append("<p><i>Pongo pygmaeus</i> picture by Greg Hume (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ASUMATRAN_ORANGUTAN.jpg'>See <i>P. pygmaeus</i> picture via Wikimedia Commons</a></p>");
        //        sources.append("<p><i>Tetraodon nigroviridis</i> picture by Starseed (Own work) [<a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0/de/deed.en'>CC-BY-SA-3.0-de</a> or <a target='_blank' rel='noopener noreferrer' href='" + creativeCommons + "/licenses/by-sa/3.0'>CC-BY-SA-3.0</a>], <a target='_blank' rel='noopener noreferrer' href='" + commonsWikipedia + "/File%3ATetraodon_nigroviridis_1.jpg'>See <i>T. nigroviridis</i> picture via Wikimedia Commons</a></p>");
        sources.append("</div>");
    ...
    protected String getAnatEntityUrl(AnatEntity anatEntity, String text) {
        ...
        return log.exit("<a target='_blank' rel='noopener noreferrer' href='" + UBERON_ID_URL +
