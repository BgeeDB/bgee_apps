...
public class HtmlGeneralDisplay extends HtmlParentDisplay implements GeneralDisplay {
    ...
    private void displayExplanations() {
        ...
        this.writeln("<p>Bgee is a database for retrieval and comparison of gene expression patterns "
                ...
                + "(bulk RNA-Seq, single-cell RNA-Seq, Affymetrix, <em>in situ</em> hybridization, "
                + "and EST data) and from multiple data sets (including "
                + "<a href='https://www.gtexportal.org/home/' title='GTEx portal' target='_blank' "
                + "rel='noopener'>GTEx data</a>).</p>");
        this.writeln("</div>");
    ...
    private void displayNews() {
        ...
        this.writeOneNews("2021-06-15", "<strong>Release of Bgee version 15 beta</strong>"
                ...
                + "to produce reliable present expression calls and expression scores for "
                + "this data type. We also use annotation procedures allowing to capture "
                + "with a high precision the cell types studied and their anatomical origin "
                + "(post-composition of ontology terms). It is straightforwardly integrated "
                + "in all our tools, along with all other data (bulk RNA-Seq, "
                + "Affymetrix, <i>in situ</i> hybridization, Expressed Sequence Tags). "
                + "For this release, we have integrated 1 481 libraries in human and mouse.</li>"
                + "<li>28 species have been added, while 5 species have been discontinued, "
                + "due to new criteria on anatomical coverage. <strong>In total, Bgee now integrates "
                + "expression data in 52 species.</strong></li>"
                + "<li>We have improved the control of False Discovery Rate to produce "
                + "present/absent expression calls. Rather than integrating boolean calls "
                + "(where present calls always dominate), we produce a p-value for each expression call "
                + "from each sample, and integrate these to produce a single call for each gene "
                + "in each condition, <strong>using a Benjamini-Hochberg procedure to control "
                + "for FDR</strong>.</li>"
                + "<li><strong>We have improved the treatment of bulk RNA-Seq data to generate "
                + "more reliable absent expression calls</strong>. We now annotate precisely "
                + "the protocol used to generate libraries (e.g., polyA, ribo-minus), "
                + "and the gene types targeted (e.g., protein coding, miRNA). "
                + "With this information, we produce absent expression calls for a gene only "
                + "if its type was accessible to the RNA-Seq protocol used.</li>"
                + "<li><strong>5 818 bulk RNA-Seq libraries have been added</strong>, "
                + "and 47 libraries removed following improved quality controls. "
                + "  <ul>"
                + "  <li>For model organisms: "
                + "    <ul>"
                + "    <li>261 added, 12 removed, for <i>Homo sapiens</i> (total library count: 5 984)</li>"
                + "    <li>73 added for <i>Mus musculus</i> (total: 566)</li>"
                + "    <li>14 for <i>Danio rerio</i> (total: 161)</li>"
                + "    <li>4 added, 35 removed, for <i>Drosophila melanogaster</i> (total: 257)</li>"
                + "    </ul>"
                + "  </li>"
                + "  <li>For animals of agronomic and veterinary relevance (see also ray-finned "
                + "fish below): "
                + "    <ul>"
                + "    <li>1 356 new libraries for <i>Bos taurus</i> (total: 2 774)</li>"
                + "    <li>594 for <i>Meleagris gallopavo</i> (new species)</li>"
                + "    <li>434 for <i>Ovis aries</i> (new species)</li>"
                + "    <li>79 for <i>Sus scrofa</i> (total: 528)</li>"
                + "    <li>64 for <i>Capra hircus</i> (new species)</li>"
                + "    <li>36 for <i>Gallus gallus</i> (total: 84)</li>"
                + "    <li>3 for <i>Equus caballus</i> (total: 248)</li>"
                + "    <li>1 for <i>Cavia porcellus</i> (total: 284)</li>"
                + "    <li>1 for <i>Canis lupus familiaris</i> (total: 162)</li>"
                + "    </ul>"
                + "  </li>"
                + "  <li>For non-model primates: "
                + "    <ul>"
                + "    <li>814 for <i>Papio anubis</i> (new species)</li>"
                + "    <li>409 for <i>Chlorocebus sabaeus</i> (new species)</li>"
                + "    <li>37 for <i>Macaca fascicularis</i> (new species)</li>"
                + "    <li>19 for <i>Macaca nemestrina</i> (new species)</li>"
                + "    <li>18 for <i>Cercocebus atys</i> (new species)</li>"
                + "    <li>18 for <i>Microcebus murinus</i> (new species)</li>"
                + "    <li>14 for <i>Callithrix jacchus</i> (new species)</li>"
                + "    <li>4 for <i>Macaca mulatta</i> (total: 264)</li>"
                + "    </ul>"
                + "  </li>"
                + "  <li>For non-model ray-finned fish: "
                + "    <ul>"
                + "    <li>333 for <i>Oryzias latipes</i> (new species)</li>"
                + "    <li>274 for <i>Gasterosteus aculeatus</i> (new species)</li>"
                + "    <li>165 for <i>Nothobranchius furzeri</i> (new species)</li>"
                + "    <li>64 for <i>Astyanax mexicanus</i> (new species)</li>"
                + "    <li>57 for <i>Gadus morhua</i> (new species)</li>"
                + "    <li>45 for <i>Poecilia reticulata</i> (new species)</li>"
                + "    <li>38 for <i>Astatotilapia calliptera</i> (new species)</li>"
                + "    <li>36 for <i>Anguilla anguilla</i> (new species)</li>"
                + "    <li>36 for <i>Scophthalmus maximus</i> (new species)</li>"
                + "    <li>32 for <i>Neolamprologus brichardi</i> (new species)</li>"
                + "    <li>32 for <i>Salmo salar</i> (new species)</li>"
                + "    <li>24 for <i>Esox lucius</i> (new species)</li>"
                + "    <li>21 for <i>Lepisosteus oculatus</i> (new species)</li>"
                + "    </ul>"
                + "  </li>"
                + "  <li>Other species: "
                + "    <ul>"
                + "    <li>274 added for <i>Heterocephalus glaber</i> (new species)</li>"
                + "    <li>57 for <i>Xenopus laevis</i> (new species)</li>"
                + "    <li>52 for <i>Branchiostoma lanceolatum</i> (new species)</li>"
                + "    <li>14 for <i>Latimeria chalumnae</i> (new species)</li>"
                + "    <li>11 for <i>Manis javanica</i> (new species)</li>"
                + "    </ul>"
                + "  </li>"
                + "  </ul>"
                + "The following species have been discontinued: <i>Erinaceus europaeus</i>, "
                + "<i>Drosophila ananassae</i>, <i>Drosophila mojavensis</i>, <i>Drosophila virilis</i>, "
                + "<i>Drosophila yakuba</i>."
                + "</li>"
                + "<li>We have updated all data from Model Organism Databases ("
                + "<a href='http://insitu.fruitfly.org/' target='_blank'>BDGP</a>, "
                + "<a href='http://flybase.org/' target='_blank'>FlyBase</a>, "
                + "<a href='http://www.informatics.jax.org/expression.shtml' target='_blank'>MGI</a>, "
                + "<a href='http://www.wormbase.org' target='_blank'>WormBase</a>, "
                + "<a href='http://www.xenbase.org/' target='_blank'>Xenbase</a>, "
                + "<a href='http://zfin.org/' target='_blank'>ZFIN</a>)</li>"
                + "<li>We have updated all genome information and all underlying ontologies used "
                + "(e.g., <a href='http://uberon.org/' target='_blank'>Uberon</a>)</li>"
                + "</ul>"
                + "<p>You can still access Bgee version 14.2 at <a title='Archive site Bgee version 14.2' "
                + "href='" + this.prop.getBgeeRootDirectory() + "bgee14_2' target='_blank' rel='noopener'>"
                + this.prop.getBgeeRootDirectory() + "bgee14_2</a>.</p>");
    ...
    private void displayMoreInfo() {
        ...
        if (!this.prop.isArchive()) {
            ...
            this.writeln("<a title='Archive site Bgee version 14.2' href='" +
                    this.prop.getBgeeCurrentUrl() + "bgee14_2/' target='_blank' rel='noopener'>version 14.2</a>");
