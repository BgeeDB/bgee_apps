...
public class ConditionFilterTest extends TestAncestor {
    ...
    public void shoudTest() {
        Condition condition1 = new Condition("ae1", "ds1");   // kept by filter 1
        Condition condition2 = new Condition("ae2", "ds1");   // kept by filter 1
        Condition condition3 = new Condition("ae2", "ds2");   // kept by filter 1
        Condition condition4 = new Condition("ae4", "ds3");   // kept by filter 2
        Condition condition5 = new Condition("ae5", "ds3");   // kept by filter 2
        Condition condition6 = new Condition("ae3", "ds1");   // kept by filter 3
        Condition condition7 = new Condition("ae5", "ds4");   // not kept even if ae5 is in filter 1
        Condition condition8 = new Condition("ae4", "ds5");   // not kept even if ds5 is in filter 1
        Condition condition9 = new Condition("ae6", "ds6");   // not kept by any filter
