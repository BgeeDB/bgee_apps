...
public class ConditionTest extends TestAncestor {
    ...
    public void testEqualsHashCodeCompareTo() {
        ...
        c1 = new Condition(null, null, null, "M", null, new Species(1));
        c2 = new Condition(null, null, null, "M", null, new Species(1));
        assertTrue("Incorrect equals", c1.equals(c2));
        assertEquals("Incorrect hashCode", c1.hashCode(), c2.hashCode());
        assertEquals("Incorrect compareTo", 0, c1.compareTo(c2));
        assertEquals("Incorrect compareTo", 0, c2.compareTo(c1));
     ...
     // different cell type IDs
        ...
        // different sexes
        c1 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct2"), "M", null, new Species(1));
        c2 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct2"), "F", null, new Species(1));
        assertFalse("Incorrect equals", c1.equals(c2));
        assertEquals("Incorrect compareTo", -1, c1.compareTo(c2));
        assertEquals("Incorrect compareTo", 1, c2.compareTo(c1));
        
        c1 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct1"), "M", null, new Species(1));
     ...
     // different strains
        c1 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct2"), "M", "wt", new Species(1));
        c2 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct2"), "M", "xo", new Species(1));
        assertFalse("Incorrect equals", c1.equals(c2));
        assertEquals("Incorrect compareTo", -1, c1.compareTo(c2));
        assertEquals("Incorrect compareTo", 1, c2.compareTo(c1));
        
        c1 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct1"), "M", "xo", new Species(1));
        c2 = new Condition(new AnatEntity("Anat1"), new DevStage("stage1"), new AnatEntity("ct1"), "M", null, new Species(1));
        assertFalse("Incorrect equals", c1.equals(c2));
        assertEquals("Incorrect compareTo", -1, c1.compareTo(c2));
        assertEquals("Incorrect compareTo", 1, c2.compareTo(c1));
