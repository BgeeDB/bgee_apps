...
public class Utils {
     ...
     * @throws IllegalArgumentException If a species ID could not be identified in the data source.
     */
    public static Map<Integer, String> checkAndGetLatinNamesBySpeciesIds(Set<Integer> speciesIds,
