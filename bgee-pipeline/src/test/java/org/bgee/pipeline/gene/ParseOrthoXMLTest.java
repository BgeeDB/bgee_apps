...
public class ParseOrthoXMLTest extends TestAncestor {
    ...
    public void shouldParseXML() 
        ...
        List<GeneTO> expectedGeneTOs = Arrays.asList(
                new GeneTO(6, "ENSDARG00000087888", null, null, null, null, 1, null, null),
                new GeneTO(12, "ENSG00000027681", null, null, null, null, 2, null, null),
                new GeneTO(21, "ENSPPYG00000014510", null, null, null, null, 3, null, null),
                new GeneTO(5, "ENSDARG00000025613", null, null, null, null, 5, null, null),
                new GeneTO(4, "ENSDARG00000089109", null, null, null, null, 6, null, null),
                new GeneTO(24, "ENSDARG00000024124", null, null, null, null, 7, null, null),
                new GeneTO(11, "ENSG00000171791", null, null, null, null, 7, null, null),
                new GeneTO(11, "ENSG00000171791", null, null, null, null, 11, null, null),
                new GeneTO(20, "ENSPPYG00000009212", null, null, null, null, 9, null, null),
                new GeneTO(13, "ENSG00000005242", null, null, null, null, 9, null, null),
                new GeneTO(7, "FBgn0003721", null, null, null, null, 11, null, null),
                new GeneTO(7, "FBgn0003721", null, null, null, null, 12, null, null),
                new GeneTO(7, "FBgn0003721", null, null, null, null, 13, null, null),
                new GeneTO(7, "FBgn0003721", null, null, null, null, 14, null, null));
...
//        
        ...
        //XXX mySQLSpeciesDAO.setAttributes is deprecated
...
//                SpeciesDAO.Attribute.GENOME_SPECIES_ID);
        //XXX taxonDAO.setAttributes is deprecated
//        verify(mockManager.mockTaxonDAO, times(1)).setAttributes(TaxonDAO.Attribute.ID);
        //XXX geneDAO.setAttributes is deprecated
//        verify(mockManager.mockGeneDAO, times(1)).setAttributes(GeneDAO.Attribute.ID);
    ...
    public void shouldParseXMLWithMappingFile() 
        ...
        verify(mockManager.mockGeneDAO).updateGenes(geneTOsArg.capture(), 
                eq(Arrays.asList(GeneDAO.Attribute.OMA_PARENT_NODE_ID)));
        log.debug(expectedGeneTOs);
        log.debug(geneTOsArg.getValue());
        assertTrue("Incorrect GeneTOs generated to update genes",
                TOComparator.areTOCollectionsEqual(expectedGeneTOs, geneTOsArg.getValue()));
...
//        verify(mockManager.mockGeneDAO, times(1)).setAttributes(GeneDAO.Attribute.ID);
    ...
    private MySQLSpeciesTOResultSet mockGetAllSpecies(MockDAOManager mockManager) {
        ...
        when(mockSpeciesTORs.getTO()).thenReturn(
                ...
                new SpeciesTO(9606, "human", null, null, null, null, null, null, null, 0),
                new SpeciesTO(7955, "zebrafish", null, null, null, null, null, null, null, 0),
                new SpeciesTO(7227, "fruitfly", null, null, null, null, null, null, null, 0),
                new SpeciesTO(9598, "chimpanzee", null, null, null, null, null, null, null, 0),
                new SpeciesTO(9597, "bonobo", null, null, null, null, null, null, null, 9598),
                new SpeciesTO(9600, "orangutan", null, null, null, null, null, null, null, 9601),
                new SpeciesTO(28377, "anolis", null, null, null, null, null, null, null, 9598),
                new SpeciesTO(6239, "c.elegans", null, null, null, null, null, null, null, 0));
        // Determine the behavior of consecutive calls to next().
        when(mockSpeciesTORs.next()).thenAnswer(new Answer<Boolean>() {
            int counter = -1;
    ...
    private MySQLGeneTOResultSet mockGetAllGenes(MockDAOManager mockManager) {
        ...
        when(mockGeneTORs.getTO()).thenReturn(
                new GeneTO(1, "ACAG00000010079", null, null, null, null, null, null, null),
                new GeneTO(2, "ENSBTAG00000019302", null, null, null, null, null, null, null),
                new GeneTO(3, "ENSGALG00000012885", null, null, null, null, null, null, null),
                new GeneTO(4, "ENSDARG00000089109", null, null, null, null, null, null, null),
                new GeneTO(5, "ENSDARG00000025613", null, null, null, null, null, null, null),
                new GeneTO(6, "ENSDARG00000087888", null, null, null, null, null, null, null),
                new GeneTO(7, "FBgn0003721", null, null, null, null, null, null, null),
                new GeneTO(8, "ENSGGOG00000000790", null, null, null, null, null, null, null),
                new GeneTO(9, "ENSGGOG00000002173", null, null, null, null, null, null, null),
                new GeneTO(10, "ENSG00000268179", null, null, null, null, null, null, null),
                new GeneTO(11, "ENSG00000171791", null, null, null, null, null, null, null),
                new GeneTO(12, "ENSG00000027681", null, null, null, null, null, null, null),
                new GeneTO(13, "ENSG00000005242", null, null, null, null, null, null, null),
                new GeneTO(14, "ENSG00000029527", null, null, null, null, null, null, null),
                new GeneTO(15, "ENSMMUG00000006577", null, null, null, null, null, null, null),
                new GeneTO(16, "ENSMUSG00000057329", null, null, null, null, null, null, null),
                new GeneTO(17, "ENSPTRG00000010079", null, null, null, null, null, null, null),
                new GeneTO(18, "PPAG00000010079", null, null, null, null, null, null, null),
                new GeneTO(19, "ENSSSCG00000004895", null, null, null, null, null, null, null),
                new GeneTO(20, "ENSPPYG00000009212", null, null, null, null, null, null, null),
                new GeneTO(21, "ENSPPYG00000014510", null, null, null, null, null, null, null),
                new GeneTO(22, "ENSRNOG00000002791", null, null, null, null, null, null, null),
                new GeneTO(23, "ENSTNIG00000000982", null, null, null, null, null, null, null),
                new GeneTO(24, "ENSDARG00000024124", null, null, null, null, null, null, null));
        // Determine the behavior of consecutive calls to next().
